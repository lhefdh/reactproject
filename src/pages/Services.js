...
export default function Services({ImgSrc}) {
    ...
    return (
      ...
      <div id="services" className="bg-white d-flex flex-column justify-content-center">
        ...
        {/* bannière avec lien dynamique qui changera selon la largeur de l'écran */}
        ...
        <div className="m-5">
          <div className="d-flex flex-wrap justify-content-center mx-1">
            <div className="col-lg-4 col-md-4 col-sm-12 p-3">
              <div className="card text-center py-1 h-auto">
                  <div className="card-body">
                    <i className="fa-solid fa-display fs-2" style={{color:"blue"}}/>
            ...
            <div  className="col-lg-4 col-md-4 col-sm-12 p-3">
              <div className="card text-center py-1 h-auto">
                <div className="card-body ">
                  <i className="fa-solid fa-file-code fs-2" style={{color:"blue"}}/>
            ...
            <div className="col-lg-4 col-md-4 col-sm-12 p-3">
              <div className="card text-center py-1 h-auto">
                <div className="card-body">
                  <i className="fa-solid fa-magnifying-glass-dollar fs-2" style={{color:"blue"}}/>
